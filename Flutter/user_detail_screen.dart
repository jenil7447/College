...
class UserDetailScreen extends StatelessWidget {
  ...
  Widget _buildProfileHeader() {
    return Container(
      ...
      child: Column(
        children: [
          Hero(
            tag: 'avatar_${userData["firstName"]}',
            child: CircleAvatar(
              radius: 50,
  ...
  Widget _buildDetailCard() {
    // Handle hobbies list from database
    List<dynamic> hobbies = userData["hobbies"] is String ? [] : userData["hobbies"] as List<dynamic>;
        ...
        children: [
          _buildDetailSection(
            ...
            [
              ...
              _buildDetailItem(Icons.accessibility, "Gender", getGenderString(userData["gender"])),
              _buildDetailItem(Icons.numbers, "Age", userData["age"].toString()),
